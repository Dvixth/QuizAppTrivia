...
//imporation des questions de niveau intermediaire de l'API et un temps< temps de
//l'activité easy
...
class MediumClassiqueActivity : AppCompatActivity() {
    ...
    private val totalTimeMillis: Long = 90000 // Temps initial pour chaque question en millisecondes
    ...
    interface TriviaApiService { //Interface de l'API trivia
        @GET("api.php?amount=50&difficulty=medium&type=multiple")
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_medium_classique)
        ...
        quizViewModel = ViewModelProvider(this).get(MediumClassiqueActivity.QuizViewModel::class.java)
        ...
        val answerButtonClickListener = View.OnClickListener { view ->
            if (questions.isNotEmpty()) {
                ...
                if (selectedAnswer == questions[currentQuestionIndex].correctAnswer) {
                    ...
                    var time=(totalTimeMillis-timeRemainingMillis)/1000
    ...
    private fun showNextQuestion() {
        ...
        if (currentQuestionIndex >= questions.size) {
            ...
            val intent = Intent(this@MediumClassiqueActivity,ScoreActivity::class.java)
    ...
    private fun RecupererQuestion() {
        ...
        triviaApiService.getQuestions(11).enqueue(object : Callback<MediumClassiqueActivity.TriviaResponse> {
            override fun onResponse(call: Call<MediumClassiqueActivity.TriviaResponse>, response: Response<MediumClassiqueActivity.TriviaResponse>) {
            ...
            override fun onFailure(call: Call<MediumClassiqueActivity.TriviaResponse>, t: Throwable) {
            }
        })
    }

    //fonction pour traiter les questions recuperees par l'API
    private fun traiterQuestions(fetchedQuestions: List<MediumClassiqueActivity.Question>) {
