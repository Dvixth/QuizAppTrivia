...
class EasyClassiqueActivity : AppCompatActivity() {
    ...
    private fun retrievePlayerLimcoins() {
    ...
    private val totalTimeMillis: Long = 120000 // Temps initial pour chaque question en millisecondes
    ...
    interface TriviaApiService { //Interface de l'API trivia
        @GET("api.php?amount=50&difficulty=easy&type=multiple")
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_easy_classique)
    ...
    private fun showNextQuestion() {
        ...
        if (currentQuestionIndex >= questions.size) {
            ...
            val intent = Intent(this@EasyClassiqueActivity,ScoreActivity::class.java)
